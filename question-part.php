			...
			<div class="app__inner">
				...
				<div class="app__main">
					<div class="text-container">
						<h3 class="app__main__title">Question part</h3>
						<?php	
					...
					<div class="container">
						<div class="control-group">
							...
							<div class="select">
										<h1>Q1: The person in the photo has a ___________ face.</h1>
											<select name="q1">
							...
							<div class="select">
										<h1>Q2: He/She seems ___________</h1>
											<select name="q2">
							...
							<div class="select">
										<h1>Q3: But I think deep down he/she is ___________</h1>
											<select name="q3">
									...
									<h1>Q4: How old is this person?</h1>
									<label> Age</label>
									<input type="number" name="q4" id='age' placeholder="Type the age">		
							
							<h1>Try to guess the favorite things of the person in the photo:</h1>
								<div class="select">
										<h1>Q5: Favorite music genre:</h1>
											<select name="q5">
								...
								<div class="select">
									<h1>Q8: Profession / Area of Study:</h1>
										<select name="q8">
