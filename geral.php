				...
				<div class="app__main">
					<div class="text-container">
						<h3 class="app__main__title">This is Jamais Vu</h3>
							<p>	1 – You fill out a form about yourself.
							<br>2 – You create a profile for a person you don’t know.
							<br>3 – Every time someone creates a profile for you, you receive it by email, and have the option of chatting with this person.
							<br>4 – Data is automatically compared and statistics are shared in the site.
						</p>
						<?php
